...
namespace metafun
{
	...
	struct number_of_signature_matches<Signature, H, T... >
	{
	    enum
	    {
		value = metafun::eval<invoker_dtl::signature_dtl::first_signature_converts_to_second<Signature, H> >() +
	...
	using self_correlation =
	    metafun::list
	    <
	       metafun::type<int>::instance<metafun::eval
	       <
		 number_of_signature_matches<Signatures, Signatures...>
	       >() >...
	    >;
